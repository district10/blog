...
挑选一个算法精深的开源项目，如 Git、Mercurial，浏览他们，记下自己觉得新奇的算法、数据结构和设计理念，写一篇博客描述项目的架构，
...
许多人拒绝改变，抵触和反对很多模式和思想，因为他们可以从现状中获得好处，
可以待在舒适区的温水中舒（man）服（xing）洗（zi）澡（sha）。
而我们可以清晰地解释自己的观点，不要像 Semmelweis 那样。

## 模式列表

#. 另辟蹊径（A Different Road）
#. 只求最差（Be the Worst）
#. 质脆玩具（Breakable Toys）^[中文翻得不好，因为英文的表达也有问题，个人感觉应该是 “okay to break” 而不是 “breakable”。]
#. 具体技能
#. 正视无知
#. 技重于艺
#. 建立馈路
...
<!--
有时间再一个个补。感谢：[35条patterns，可以放在案头 (评论: Apprenticeship Patterns)](http://book.douban.com/review/3770148/)
-->
